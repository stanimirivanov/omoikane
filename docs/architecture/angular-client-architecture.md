...
> **Document ID:** OMO-ARC-006  
> **Status:** Implemented architecture description  
> **Applies to:** `apps/client`
...
[OMO-UX-001](../product/ui-ux-redesign-plan.md) and
[ADR-0003](adr/0003-angular-material-and-lucide-presentation-foundation.md).
Angular Material and Lucide provide accessible primitives and icons; Omoikane
owns product layout, information hierarchy, and design tokens. The global SCSS
entry owns theming, document defaults, focus visibility, and reduced-motion
behavior. Responsive drawers retain local presentation state, while feature
stores, URL parameters, application workflows, and database authorization keep
their existing ownership. The completed UI-0 through UI-8 history and review
evidence remain in OMO-UX-001 rather than this integrated architecture
description.
...
## Decision Forensics presentation
...
## Feature ownership and behavior
...
### Channels and realtime collaboration
